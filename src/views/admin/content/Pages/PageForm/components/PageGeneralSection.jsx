...
const PageGeneralSection = ({ control, errors }) => {
    ...
    const handleEditorImageUploadAndCrop = async (blobInfo) => {
        ...
        try {
            ...
            const croppedFile = new File([croppedImageBlob], blobInfo.filename(), { type: croppedImageBlob.type });
                        ...
                        render={({ field }) => (
                            <Editor
                                ...
                                init={{
                                    ...
                                    images_upload_handler: handleEditorImageUploadAndCrop, // Ganti fungsi lama
