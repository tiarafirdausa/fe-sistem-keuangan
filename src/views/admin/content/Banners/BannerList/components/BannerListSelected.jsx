...
const BannerListSelected = () => {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await Promise.all(
                selectedBanners.map((banner) => apiDeleteBanner(banner.id)) // Menggunakan apiDeleteBanner
            );
            mutate();
            setSelectAllBanners([]);
            ...
            toast.push(
                <div className="flex items-center">
                    ...
                    />
                    <span>Successfully deleted {selectedBanners.length} banner(s)!</span>
                </div>
            );
        } catch (error) {
            ...
            toast.push(
                <div className="flex items-center">
                    ...
                    />
                    <span>Failed to delete banner(s). Please try again.</span>
                </div>
            );
        }
    };
    ...
    return (
        <>
            ...
            >
                <p>
                    Are you sure you want to remove these banners? This action
                    can&apos;t be undone.
                </p>
            </ConfirmDialog>
        </>
...
export default BannerListSelected;