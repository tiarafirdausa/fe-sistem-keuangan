...
const CommentListSelected = () => { 
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await Promise.all(
                selectedComments.map((comment) => apiDeleteComment(comment.id)) 
            );
            ...
            toast.push(
                <div className="flex items-center">
                    ...
                    />
                    <span>Successfully deleted {selectedComments.length} comment(s)!</span> 
                </div>
            );
        } catch (error) {
            ...
            toast.push(
                <div className="flex items-center">
                    ...
                    />
                    <span>Failed to delete comment(s). Please try again.</span>
                </div>
            );
        }
    };
    ...
    return (
        <>
            ...
            >
                <p>
                    Are you sure you want to remove these comments? This action
                    can&apos;t be undone.
                </p>
            </ConfirmDialog>
        </>
...
export default CommentListSelected;
