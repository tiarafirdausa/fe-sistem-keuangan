...
const SocialLinkListSelected = () => {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await Promise.all(
                selectedSocialLinks.map((socialLink) => apiDeleteSocialLink(socialLink.id)) 
            );
            mutate(); 
            setSelectAllSocialLinks([]); 
    ...
    return (
        <>
            ...
            >
                <p>
                    Are you sure you want to remove these social links? This action
                    can&apos;t be undone.
                </p> 
            </ConfirmDialog>
        </>
...
export default SocialLinkListSelected;